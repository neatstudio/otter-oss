<?php
/**
 * @category AliOssAdapter
 * @created 2020/8/11 10:21
 * @since
 */
...
class AliOssAdapter extends AbstractAdapter
{
     ...
     * @param array     $options
     */
    public function __construct(OssClient $client, $bucket, $endPoint, $prefix = null, array $options = [])
    {
        $this->client = $client;
        $this->bucket = $bucket;
    ...
    public function write($path, $contents, Config $config)
    {
        ...
        try {
            ...
            logs()->debug('puterror----------', [$e->getMessage()]);
            return false;
        }
    ...
    public function delete($path)
    {
        ...
        try {
            ...
            logs()->debug('OSS::DELETE', [$e->getMessage()]);
            return false;
        }
    ...
    public function deleteDir($dirname)
    {
        ...
        try {
            ...
            logs()->debug('OSS::DELETE_DIR', [$e->getMessage()]);
            return false;
        }
